...
int gr_light_cmd(lua_State* L)
{
  ...
  double intensity = luaL_checknumber(L, 4);
...
int gr_material_cmd(lua_State* L)
{
  ...
  double rfr_index = luaL_checknumber(L, 6);
  double glossiness = luaL_checknumber(L, 7);
  double pd = luaL_checknumber(L, 8);
  double ps = luaL_checknumber(L, 9);
  int vol_s = luaL_checknumber(L, 10);
  int negative = luaL_checknumber(L, 11);
